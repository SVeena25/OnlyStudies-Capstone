            ...
            'MBA': {
                ...
                'subcategories': [
                    ...
                    },
                    {
                        'name': 'Marketing',
                        'description': (
                            'Digital marketing, brand management, and '
                            'market strategy'
                        ),
                    },
                    {
                        'name': 'Operations',
                        'description': (
                            'Supply chain, operations management, and '
                            'logistics'
                        ),
                    },
                ]
            ...
            'Engineering': {
                ...
                'subcategories': [
                    ...
                    },
                    {
                        'name': 'Mechanical',
                        'description': (
                            'Mechanical design, thermodynamics, and '
                            'manufacturing'
                        ),
                    },
                    {
            ...
            'Medical': {
                ...
                'subcategories': [
                    ...
                    },
                    {
                        'name': 'Nursing',
                        'description': (
                            'Nursing education and healthcare '
                            'certification'
                        ),
                    },
                ]
        ...
        for cat_name, cat_data in categories_data.items():
            ...
            for subcat_data in cat_data['subcategories']:
                ...
                if subcat_created:
                    self.stdout.write(
                        self.style.SUCCESS(
                            f'  Created subcategory: {subcat_data["name"]}'
                        )
                    )
                else:
                    self.stdout.write(
                        f'  Subcategory already exists: {subcat_data["name"]}')

        self.stdout.write(
            self.style.SUCCESS(
                'Successfully populated all categories and subcategories!')
        )
